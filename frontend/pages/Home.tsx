          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="mt-4 max-w-md mx-auto lg:mx-0 text-base text-primary-100 sm:text-lg md:max-w-2xl">
                  Join our platform to participate in local decision-making, share your ideas,
                  and make a real difference in your community.
                </p>
                <div className="mt-6 max-w-md mx-auto lg:mx-0 sm:flex sm:justify-start">
